...
typedef CredentialDialogFactory = Future<Credential?> Function(List<Credential> credentials);

extension ApiExt on Api {

 Future<AssertionVerifyRequestBody> createAssertionFromPublic(Map<String, dynamic> publicKey, String origin, {CredentialDialogFactory? factory}) async{
   final webApi = WebAPI();
   ...
   final assertion = await Authenticator.handleGetAssertion(getAssertionOptions, credentialSelector: factory);
